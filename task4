...
//    for (int i = 0; i < numberOfStudents; i++) {
//        cout << "Information of " << ordinal(i + 1) <<  " student:" << endl;
//        Student now = students[i];
//        printStudent(now);
//    }


//    Print all the students' id whose CGPA is 3.75 or above
...
//    Print all the students' id who has completed more than 50 credits
...
//    Print all the students' id who has completed minimum 2 semesters and minimum 28 credits
